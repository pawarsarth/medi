      ...
      /*  $precautions = [
        ...
        //   echo $count;
           if($count>0 )
           {
			...
			echo  "<br><br><br><center>".$row['hospital_info']."<center>";
        ...
        {
            echo '<p style="font-size: 30px; background-color: #333; color: red; text-align: center;" >No hospitals are  found for the given disease <br> please pronounce  diseases name properly </p>';
        }
